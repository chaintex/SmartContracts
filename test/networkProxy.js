...
// const NetworkNoMaxDest = artifacts.require("NetworkNoMaxDest.sol");
...
//
//         await network.setNetworkProxy(networkProxy.address);
//
//         await networkProxy.setNetworkContract(network.address);
...
//
//             //trade
//             let txData = await networkProxy.trade(ethAddress, totalPayValue, permissionlessTok.address, user2, 10 ** 30,
//                             rate[1], 0, {from:user1, value:totalPayValue});
...
//             let txData = await networkProxy.trade(permissionlessTok.address, totalPayValue, ethAddress, user2,
//                         10 ** 30, rate[1], 0, {from:user1});
...
//             let txData = await networkProxy.trade(ethAddress, tradeValue, token0, user2,
//                         10 ** 30, rate[1], 0, {from:user1, value: tradeValue});
//
